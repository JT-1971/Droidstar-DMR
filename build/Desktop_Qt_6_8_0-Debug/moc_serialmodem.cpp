...
struct qt_meta_stringdata_CLASSSerialModemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSerialModemENDCLASS = QtMocHelpers::stringData(
    "SerialModem",
    "data_ready",
    "",
    "modem_data_ready",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSerialModemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SerialModem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSerialModemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSerialModemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSerialModemENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SerialModem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSerialModemENDCLASS.stringdata0))
