...
namespace {
struct qt_meta_stringdata_REF_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_REF_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_REF_t qt_meta_stringdata_REF = {
    {
        QT_MOC_LITERAL(0, 3),  // "REF"
...
Q_CONSTINIT static const uint qt_meta_data_REF[] = {
...
Q_CONSTINIT const QMetaObject REF::staticMetaObject = { {
    ...
    qt_meta_stringdata_REF.offsetsAndSizes,
    qt_meta_data_REF,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_REF_t,
        // Q_OBJECT / Q_GADGET
...
void *REF::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_REF.stringdata0))
