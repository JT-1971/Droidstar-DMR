...
struct qt_meta_stringdata_CLASSDCSENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDCSENDCLASS = QtMocHelpers::stringData(
    "DCS",
    "toggle_tx",
    "",
    "start_tx",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDCSENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DCS::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDCSENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDCSENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDCSENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DCS::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDCSENDCLASS.stringdata0))
